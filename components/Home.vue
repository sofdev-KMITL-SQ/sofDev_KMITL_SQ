      ...
      <v-carousel-item :src="require('@/assets/img/home/slider4.jpg')">
        <v-row class="fill-height" align="center" justify="center">
          <div class="display-2 white--text pl-5 pr-5 hidden-sm-only">
            <strong>ลดสูงสุด -60% + Extra 10%</strong>
          </div>
          <br />
        </v-row>
      </v-carousel-item>
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <v-card>
          <v-img
            ...
            height="400px"
          >
            <h1 class="text-center font-size">สุดฮิต</h1>
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <v-card>
          <v-img
            ...
            height="400px"
          >
            <h1 class="text-center font-size">ของใหม่</h1>
            <div class="text-center">
              <v-btn href="/shop" class="white--text" outlined>SHOP NOW</v-btn>
            </div>
          </v-img>
...
.products-Types {
  ...
  animation: turn 3.5s ease-out backwards 1s;
}
/*.btn-warning {
    background-color: #F49A6A !important;
}*/
.btn-primary {
  color: #fff;
